...
model = dict(
    ...
    backbone=dict(
        ...
        inflate=(0, 0, 1, 1),
        norm_eval=False),
    neck=dict(type='DoubleTransformer',frame=8,depth=3),
    cls_head=dict(
        type='DTransHead',
        num_classes=288,
        in_channels=768,
...
train_cfg = dict(
    type='EpochBasedTrainLoop', max_epochs=160, val_begin=1, val_interval=10)
...
work_dir = './work_dirs/slowonly_gym288-12-8zhen'
