...
model = dict(neck=dict(aux_head_cfg=dict(out_channels=99, loss_weight=0.5)),cls_head=dict(num_classes=99,dropout_ratio=0.5))
#model = dict(cls_head=dict(num_classes=99,dropout_ratio=0.5))
train_pipeline = [
...
work_dir = './work_dirs/slowonly_gym99_24-311-16zhen'
