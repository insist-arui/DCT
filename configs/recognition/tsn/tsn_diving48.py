...
# model settings
model = dict(cls_head=dict(num_classes=48, dropout_ratio=0.5))
# model = dict(cls_head=dict(num_classes=48, dropout_ratio=0.5))
# dataset settings
...
train_cfg = dict(
    type='EpochBasedTrainLoop', max_epochs=120, val_begin=1, val_interval=20)
...
work_dir = './work_dirs/tsn_diving48_23-93-8zhen'
