...
# model settings
model = dict(cls_head=dict(num_classes=288, dropout_ratio=0.5))
...
train_cfg = dict(
    type='EpochBasedTrainLoop', max_epochs=140, val_begin=1, val_interval=10)
...
work_dir = './work_dirs/tsn_gym288-98-8zhen'
