...
train_file_org = osp.join(annotation_root, 'gym288_train_org.txt')
val_file_org = osp.join(annotation_root, 'gym288_val_org.txt')
train_file = osp.join(annotation_root, 'gym288_train.txt')
val_file = osp.join(annotation_root, 'gym288_val.txt')
